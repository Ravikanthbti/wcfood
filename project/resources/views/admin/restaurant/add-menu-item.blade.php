                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                            <input type="text" id="required2" name="item_name" class="form-control" required value="{{ old('item_name') }}" onkeypress="return (event.charCode > 
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" id="required2" name="price" class="form-control" required value="{{ old('price') }}"/>
                                                @error('price')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
