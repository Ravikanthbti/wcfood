                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        <input type="hidden" id="required2" name="restaurant_id" class="form-control" required value="{{ $menu->restaurant_id }}" />
                                        <div class="form-group col-md-4" >
                                            <label class="control-label control_name"> Menu Name:</label>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text" id="required2" name="menu_name" class="form-control" required value="{{ $menu->menu_name }}"   onkeypress="return (event.charCode > 
