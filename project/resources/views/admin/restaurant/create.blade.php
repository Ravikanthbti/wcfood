                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" id="required2" name="name" class="form-control" required value="{{ old('name') }}" onkeypress="return (event.charCode > 
...
<!--                    <input type="text" id="required2" name="category" class="form-control" required />-->
        ...
        <div class="col-md-12">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <input type="text" id="required2" name="price_range" class="form-control" required  value="{{ old('price_range') }}"/>
                        @error('price_range')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="email" id="required2" name="email" class="form-control" required  value="{{ old('email') }}"/>
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="password" id="required2" name="password" class="form-control" required value="{{ old('password') }}"/>
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="text" id="required2" name="cont_p_name" class="form-control" required  value="{{ old('cont_p_name') }}" onkeypress="return (event.charCode > 
    64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" maxlength="35" />
                        @error('cont_p_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="email" id="required2" name="cont_P_email" class="form-control" required  value="{{ old('cont_P_email') }}"/>
                        @error('cont_P_email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="number" id="required2" name="min_order_price" class="form-control" required value="{{ old('min_order_price') }}"/>
